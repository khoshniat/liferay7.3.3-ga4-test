...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo addFoo(ir.sain.test.model.Foo foo) {
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo deleteFoo(ir.sain.test.model.Foo foo) {
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo deleteFoo(long fooId)
	...
	@Override
	public ir.sain.test.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<ir.sain.test.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<ir.sain.test.model.Foo> getFoosByUuidAndCompanyId(
	...
	public java.util.List<ir.sain.test.model.Foo> getFoosByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<ir.sain.test.model.Foo>
			orderByComparator) {
	 ...
	 */
	@Override
	public ir.sain.test.model.Foo updateFoo(ir.sain.test.model.Foo foo) {

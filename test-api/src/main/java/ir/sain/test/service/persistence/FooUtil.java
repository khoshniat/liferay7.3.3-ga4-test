...
package ir.sain.test.service.persistence;
...
public class FooUtil {
	...
	public static Foo findByUuid_First(
		...
		throws ir.sain.test.exception.NoSuchFooException {

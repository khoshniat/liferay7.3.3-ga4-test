 ...
 * <code>ir.sain.test.service.impl.FooLocalServiceImpl</code> and
...
public class FooLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>ir.sain.test.service.impl.FooLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static ir.sain.test.model.Foo addFoo(ir.sain.test.model.Foo foo) {
	 ...
	 * @return the new foo
	 */
	public static ir.sain.test.model.Foo createFoo(long fooId) {
	 ...
	 */
	public static ir.sain.test.model.Foo deleteFoo(ir.sain.test.model.Foo foo) {
	 ...
	 */
	public static ir.sain.test.model.Foo deleteFoo(long fooId)
	...
	public static ir.sain.test.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	public static ir.sain.test.model.Foo fetchFooByUuidAndGroupId(
	 ...
	 * @throws PortalException if a foo with the primary key could not be found
	 */
	public static ir.sain.test.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static ir.sain.test.model.Foo getFooByUuidAndGroupId(
			String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	public static java.util.List<ir.sain.test.model.Foo> getFoos(
		int start, int end) {
	 ...
	 */
	public static java.util.List<ir.sain.test.model.Foo>
	...
	public static java.util.List<ir.sain.test.model.Foo>
		getFoosByUuidAndCompanyId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<ir.sain.test.model.Foo> orderByComparator) {
	 ...
	 */
	public static ir.sain.test.model.Foo updateFoo(ir.sain.test.model.Foo foo) {

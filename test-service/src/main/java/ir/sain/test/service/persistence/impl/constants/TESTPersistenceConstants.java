...
package ir.sain.test.service.persistence.impl.constants;
...
public class TESTPersistenceConstants {
	...
	public static final String BUNDLE_SYMBOLIC_NAME = "ir.sain.test.service";
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(TESTPersistenceConstants.class);

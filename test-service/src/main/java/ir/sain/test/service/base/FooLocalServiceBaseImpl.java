...
package ir.sain.test.service.base;
...
import ir.sain.test.service.FooLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ir.sain.test.service.impl.FooLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ir.sain.test.service.impl.FooLocalServiceImpl
 * @generated
 */
public abstract class FooLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FooLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ir.sain.test.service.FooLocalServiceUtil</code>.
	 */

...
package ir.sain.test.service.persistence.impl;
...
import ir.sain.test.exception.NoSuchFooException;
import ir.sain.test.model.Foo;
import ir.sain.test.model.impl.FooImpl;
import ir.sain.test.model.impl.FooModelImpl;
import ir.sain.test.service.persistence.FooPersistence;
import ir.sain.test.service.persistence.impl.constants.TESTPersistenceConstants;
...
public class FooPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.ir.sain.test.model.Foo"),
			true);
	}
	...
	static {
		try {
			Class.forName(TESTPersistenceConstants.class.getName());
		}
